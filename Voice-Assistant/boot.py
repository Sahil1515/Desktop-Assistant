...
def speak(mytext):
    ...
    os.system("play " + "welcome.mp3"+" tempo 1.4")
...
#     server.login("sahilsainisalaria@gmail.com","Sahilsainisalarianew@1515")
#     server.sendmail("sahilsainisalaria@gmail.com",to,content)
#     server.close()
...
# try:
# sendMail("tetangh@gmail.com","Hi brother how are you")
# except:
